...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有相册表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存相册表")
@ApiOperation("保存相册表")
...
@SysLog(MODULE = "sys", REMARK = "更新相册表")
@ApiOperation("更新相册表")
...
@SysLog(MODULE = "sys", REMARK = "删除相册表")
@ApiOperation("删除相册表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("相册表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给相册表分配相册表")
@ApiOperation("查询相册表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("相册表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("相册表id");
        }
