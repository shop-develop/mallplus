...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有产品分类列表")
...
@SysLog(MODULE = "sys", REMARK = "保存产品分类")
@ApiOperation("保存产品分类")
...
@SysLog(MODULE = "sys", REMARK = "更新产品分类")
@ApiOperation("更新产品分类")
...
@SysLog(MODULE = "sys", REMARK = "删除产品分类")
@ApiOperation("删除产品分类")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("产品分类id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给产品分类分配产品分类")
@ApiOperation("查询产品分类明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("产品分类id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("产品分类id");
        }
