...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有商品属性参数表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存商品属性参数表")
...
@SysLog(MODULE = "sys", REMARK = "更新商品属性参数表")
...
@SysLog(MODULE = "sys", REMARK = "删除商品属性参数表")
@ApiOperation("删除商品属性参数表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("商品属性参数表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给商品属性参数表分配商品属性参数表")
@ApiOperation("查询商品属性参数表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("商品属性参数表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("商品属性参数表id");
        }
