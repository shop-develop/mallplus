...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有商品信息列表")
...
@SysLog(MODULE = "sys", REMARK = "保存商品信息")
@ApiOperation("保存商品信息")
...
@SysLog(MODULE = "sys", REMARK = "更新商品信息")
@ApiOperation("更新商品信息")
...
@SysLog(MODULE = "sys", REMARK = "删除商品信息")
@ApiOperation("删除商品信息")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("商品信息id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给商品信息分配商品信息")
@ApiOperation("查询商品信息明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("商品信息id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("商品信息id");
        }
