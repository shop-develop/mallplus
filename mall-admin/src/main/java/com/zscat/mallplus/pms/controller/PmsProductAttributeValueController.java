...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有存储产品参数信息的表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存存储产品参数信息的表")
...
@SysLog(MODULE = "sys", REMARK = "更新存储产品参数信息的表")
...
@SysLog(MODULE = "sys", REMARK = "删除存储产品参数信息的表")
@ApiOperation("删除存储产品参数信息的表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("存储产品参数信息的表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给存储产品参数信息的表分配存储产品参数信息的表")
@ApiOperation("查询存储产品参数信息的表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("存储产品参数信息的表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("存储产品参数信息的表id");
        }
