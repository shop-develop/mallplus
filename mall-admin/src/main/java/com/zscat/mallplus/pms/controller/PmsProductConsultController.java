...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有产品咨询表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存产品咨询表")
...
@SysLog(MODULE = "sys", REMARK = "更新产品咨询表")
...
@SysLog(MODULE = "sys", REMARK = "删除产品咨询表")
@ApiOperation("删除产品咨询表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("产品咨询表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给产品咨询表分配产品咨询表")
@ApiOperation("查询产品咨询表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("产品咨询表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("产品咨询表id");
        }
