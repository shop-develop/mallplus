...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有产品属性分类表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存产品属性分类表")
...
@SysLog(MODULE = "sys", REMARK = "更新产品属性分类表")
...
@SysLog(MODULE = "sys", REMARK = "删除产品属性分类表")
@ApiOperation("删除产品属性分类表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("产品属性分类表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给产品属性分类表分配产品属性分类表")
@ApiOperation("查询产品属性分类表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("产品属性分类表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("产品属性分类表id");
        }
