...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有品牌表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存品牌表")
@ApiOperation("保存品牌表")
...
@SysLog(MODULE = "sys", REMARK = "更新品牌表")
@ApiOperation("更新品牌表")
...
@SysLog(MODULE = "sys", REMARK = "删除品牌表")
@ApiOperation("删除品牌表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("品牌表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给品牌表分配品牌表")
@ApiOperation("查询品牌表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("品牌表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("品牌表id");
        }
