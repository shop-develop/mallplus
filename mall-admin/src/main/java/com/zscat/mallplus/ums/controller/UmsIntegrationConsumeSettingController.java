...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有积分消费设置列表")
...
@SysLog(MODULE = "sys", REMARK = "保存积分消费设置")
...
@SysLog(MODULE = "sys", REMARK = "更新积分消费设置")
...
@SysLog(MODULE = "sys", REMARK = "删除积分消费设置")
@ApiOperation("删除积分消费设置")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("积分消费设置id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给积分消费设置分配积分消费设置")
@ApiOperation("查询积分消费设置明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("积分消费设置id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("积分消费设置id");
        }
