...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有会员积分成长规则表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存会员积分成长规则表")
...
@SysLog(MODULE = "sys", REMARK = "更新会员积分成长规则表")
...
@SysLog(MODULE = "sys", REMARK = "删除会员积分成长规则表")
@ApiOperation("删除会员积分成长规则表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("会员积分成长规则表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给会员积分成长规则表分配会员积分成长规则表")
@ApiOperation("查询会员积分成长规则表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("会员积分成长规则表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("会员积分成长规则表id");
        }
