...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有会员统计信息列表")
...
@SysLog(MODULE = "sys", REMARK = "保存会员统计信息")
...
@SysLog(MODULE = "sys", REMARK = "更新会员统计信息")
...
@SysLog(MODULE = "sys", REMARK = "删除会员统计信息")
@ApiOperation("删除会员统计信息")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("会员统计信息id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给会员统计信息分配会员统计信息")
@ApiOperation("查询会员统计信息明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("会员统计信息id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("会员统计信息id");
        }
