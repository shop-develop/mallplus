...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有人气推荐商品表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存人气推荐商品表")
...
@SysLog(MODULE = "sys", REMARK = "更新人气推荐商品表")
...
@SysLog(MODULE = "sys", REMARK = "删除人气推荐商品表")
@ApiOperation("删除人气推荐商品表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("人气推荐商品表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给人气推荐商品表分配人气推荐商品表")
@ApiOperation("查询人气推荐商品表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("人气推荐商品表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("人气推荐商品表id");
        }
