...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有优惠卷表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存优惠卷表")
@ApiOperation("保存优惠卷表")
...
@SysLog(MODULE = "sys", REMARK = "更新优惠卷表")
@ApiOperation("更新优惠卷表")
...
@SysLog(MODULE = "sys", REMARK = "删除优惠卷表")
@ApiOperation("删除优惠卷表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("优惠卷表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给优惠卷表分配优惠卷表")
@ApiOperation("查询优惠卷表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("优惠卷表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("优惠卷表id");
        }
