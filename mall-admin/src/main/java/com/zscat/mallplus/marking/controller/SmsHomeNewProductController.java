...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有新鲜好物表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存新鲜好物表")
...
@SysLog(MODULE = "sys", REMARK = "更新新鲜好物表")
...
@SysLog(MODULE = "sys", REMARK = "删除新鲜好物表")
@ApiOperation("删除新鲜好物表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("新鲜好物表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给新鲜好物表分配新鲜好物表")
@ApiOperation("查询新鲜好物表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("新鲜好物表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("新鲜好物表id");
        }
