...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有商品限时购与商品关系表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存商品限时购与商品关系表")
...
@SysLog(MODULE = "sys", REMARK = "更新商品限时购与商品关系表")
...
@SysLog(MODULE = "sys", REMARK = "删除商品限时购与商品关系表")
@ApiOperation("删除商品限时购与商品关系表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("商品限时购与商品关系表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给商品限时购与商品关系表分配商品限时购与商品关系表")
@ApiOperation("查询商品限时购与商品关系表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("商品限时购与商品关系表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("商品限时购与商品关系表id");
        }
