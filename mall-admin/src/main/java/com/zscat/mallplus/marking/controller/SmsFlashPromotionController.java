...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有限时购表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存限时购表")
@ApiOperation("保存限时购表")
...
@SysLog(MODULE = "sys", REMARK = "更新限时购表")
@ApiOperation("更新限时购表")
...
@SysLog(MODULE = "sys", REMARK = "删除限时购表")
@ApiOperation("删除限时购表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("限时购表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给限时购表分配限时购表")
@ApiOperation("查询限时购表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("限时购表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("限时购表id");
        }
