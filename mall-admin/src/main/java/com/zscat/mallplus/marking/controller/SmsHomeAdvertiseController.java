...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有首页轮播广告表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存首页轮播广告表")
...
@SysLog(MODULE = "sys", REMARK = "更新首页轮播广告表")
...
@SysLog(MODULE = "sys", REMARK = "删除首页轮播广告表")
@ApiOperation("删除首页轮播广告表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("首页轮播广告表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给首页轮播广告表分配首页轮播广告表")
@ApiOperation("查询首页轮播广告表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("首页轮播广告表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("首页轮播广告表id");
        }
