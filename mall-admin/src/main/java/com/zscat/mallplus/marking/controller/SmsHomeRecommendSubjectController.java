...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有首页推荐专题表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存首页推荐专题表")
...
@SysLog(MODULE = "sys", REMARK = "更新首页推荐专题表")
...
@SysLog(MODULE = "sys", REMARK = "删除首页推荐专题表")
@ApiOperation("删除首页推荐专题表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("首页推荐专题表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给首页推荐专题表分配首页推荐专题表")
@ApiOperation("查询首页推荐专题表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("首页推荐专题表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("首页推荐专题表id");
        }
